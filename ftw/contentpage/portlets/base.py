...
class IBasePortlet(IPortletDataProvider):
...
class AddForm(form.AddForm):
    ...
    label = _(u'Add Base Portlet')
    description = _(u'This Portlet displays Nothing')

    fields = field.Fields(IBasePortlet)
...
class Renderer(base.Renderer):
    ...
    def get_items(self, portal_type, date_field, sort_order, all_items=False):
        ...
        if self.data.days > 0 and not all_items:
